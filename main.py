...
def draw_information_game(surface):
    ...
    name_info_student1 = pg.font.Font('font/pridil.ttf', 20).render('Huỳnh Ngô Anh Thái - N19DCCN188', True, BLACK)
    day_info = pg.font.Font('font/pridil.ttf', 20).render('TP Hồ Chí Minh Ngày 01 Tháng 03 Năm 2023', True, BLACK)
